  ...
  if (variant === 'compact') {
    return (
      ...
      >
        ...
        {/* Mentor image or initial */}
        <div
          className="w-12 h-12 rounded-full border-2 border-imperial-gold flex items-center justify-center text-xl font-headline overflow-hidden"
    ...
    >
      ...
      <div className="relative p-6 space-y-4">
        ...
        <div className="flex items-center gap-4">
          {/* Mentor image */}
          <div className="w-16 h-16 rounded-full border-2 border-imperial-gold overflow-hidden flex-shrink-0">
            {mentor.image ? (
              <img
                src={mentor.image}
                alt={mentor.name}
              ...
              <div
                className="w-full h-full flex items-center justify-center text-xl font-headline text-imperial-gold"
